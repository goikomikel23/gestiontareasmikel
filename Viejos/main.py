...
class Subject(webapp2.RequestHandler):
...
class NewSubject(webapp2.RequestHandler):
    ...
    def post(self):
        ...
        if sub == 0:
            ...
            self.response.write('<!doctype html><html><body>alert("The subject has been added")</body></html>')
...
class Subject(ndb.Model):
    ...
    profesor = ndb.StringProperty(required=True)
